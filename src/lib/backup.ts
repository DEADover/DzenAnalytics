...
export const BACKUP_EXCLUDED_KEYS: Record<string, string> = {
  ...
  // Временный выбор оформления главной: живёт только пока идёт сравнение
  // вариантов и исчезнет вместе с ними. Восстанавливать его на другом
  // устройстве незачем, а после выбора ключ и вовсе перестанет существовать.
  dashboardVariant: "выбранный вариант главной, временная настройка",
};
