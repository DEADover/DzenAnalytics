 ...
 * дням, отобрать те, где подсказка достаточно уверенная, чтобы применить её
 * пачкой.
 */
...
/** Порог, с которого подсказка считается надёжной и предлагается пачкой. */
...
export interface SuggestionStats {
  ...
  applicable: number;
  /** Из них надёжные — уверенность не ниже порога. */
  confident: number;
}
