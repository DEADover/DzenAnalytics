...
export function buildTemplateSheets(
  ...
  const howto: Cell[][] = [
    ...
    [note("7."), muted("Время можно не заполнять — поставим 12:00. После отправки в Дзен-мани время операции уже не изменить.")],
    [note("8."), muted("На листе «Операции» у каждой колонки есть заметка: наведите на её название — там написано, для каких типов операций она нужна.")],
    [note(""), note("")],
