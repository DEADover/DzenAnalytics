        ...
        right={
          <InfoPopover>
            <p>
              ...
              список обрывался бы на провале в данных. А вот длинный пробел —
              больше трёх месяцев подряд без операций — пропускается целиком:
              одна случайная операция многолетней давности иначе растянула бы
              ленту на сотни пустых строк.
            </p>
            <p>
