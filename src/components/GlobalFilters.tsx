  ...
  return (
    <div className="mb-4 md:mb-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {currencies.length > 1 && (
          <MultiSelect
            // Кнопка уже соседей: коды валют короткие, и 13rem там держали
            // пустоту. А вот МЕНЮ по кнопке равнять нельзя — при `0` оно
            // повторяло её ширину, и шапка «4 валюты · Выбрать все» ломалась
            // на две строки. Ширины разведены: кнопке узко, меню просторно.
