  ...
  return (
    ...
    <Popover open anchorRef={anchorRef} onClose={onClose} className="w-52 card p-2.5 shadow-lg">
      ...
      >
        ...
        {/* Копия и сохранение — рядом, у левого края, по одной линии с суммой
            и чипами: кнопка по подписи, а не на всю ширину — окно из одного
            поля не должно кричать кнопкой. */}
