...
export function WhatIfCategories({
  ...
  return (
    <SectionCard
      ...
      info="Прикиньте, как изменится расход, если тратить больше или меньше в отдельных категориях. Добавьте категорию и задайте изменение в процентах — от её среднего расхода за те же месяцы, что и «Сейчас». Если сдвинуть и общий «Расход в месяц», он применится поверх: кафе −50% и расход −10% вместе дадут по кафе −55%."
      right={
        Math.round(delta) !== 0 && (
