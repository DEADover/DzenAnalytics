...
export function WhatIfCategories({
  ...
  return (
    <SectionCard
      ...
      info="Меняется средний расход категории за те же месяцы, что и база. Категории применяются раньше общего изменения расхода: «кафе −50%» и «расходы −10%» дают кафе −55%."
      right={
        Math.round(delta) !== 0 && (
