...
export function HeaderSyncActions({ leading }: { leading?: ReactNode }) {
  ...
  return (
    ...
    <div className="relative inline-flex items-center shrink-0">
      ...
      <div
        className={clsx(
          // Дорожка того же вида, что меню и значки рядом в шапке: углы
          // блоков страницы (`seg-block`). Прежде это была обойма со
          // скруглением в восемь пикселей — в ряду, где всё остальное одного
