...
interface Props {
  ...
  iconTone?: string;
  /**
   * Подпись рядом с заголовком: одной короткой строкой, что здесь можно понять
   * или сделать. Подпись раздела в меню «Ещё» (`navSections`) говорит, что
   * внутри, — эта её не повторяет.
   */
  hint?: ReactNode;
  /**
