 ...
 *
 * В дорожке ровно шесть мест, и место может пустовать. Ряд из шести плиток ещё
 ...
 * нужно больше шести, тот ставит вторую дорожку.
 *
 * В режиме настройки дорожка правится на месте: пустое место зовёт плюсом,
 * кнопка перетаскивается на любое другое место, крестик её снимает. Настраивать
 * дорожку в отдельном окне было бы дальше от того, что человек видит.
 */
              ...
              <button
                ...
                title={
                  filled <= 1
                    ...
                    : `Убрать «${section.label}» из дорожки`
                }
                aria-label={`Убрать «${section.label}» из дорожки`}
