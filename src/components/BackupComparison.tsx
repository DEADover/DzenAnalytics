        ...
        <table className="w-full text-xs border-collapse">
          ...
          <tbody>
            <Row
              ...
              cloud="Копия аккаунта Дзен-мани целиком: операции, счета, категории, контрагенты и планы — в том виде, в каком их хранит сам сервис."
            />
            <Row
              label="Где лежит"
              local="Файлом у вас на устройстве."
              cloud="В браузере, последние пять. Любой можно сохранить файлом. Принимается и бэкап ZenTable — json, zip или gz."
            />
            <Row
              label="Что вернёт"
              local="Настройки, правила, бюджеты и неотправленные правки — всё как было. Операции тоже вернутся, но только до следующей синхронизации: дальше их заменят те, что придут из Дзен-мани."
              cloud="Операции, счета, категории и контрагентов — в самом Дзен-мани. Планы снимок хранит, но пока не возвращает. Настройки сервиса он не хранит и не вернёт."
            />
            <Row
              label="Когда нужна"
