...
export function CloudSettingsCard() {
  ...
  const status = !enabled
    ? "Выключено — настройки живут только в этом браузере"
    : busy
  ...
  return (
    <div className="card-tray card-pad">
      <SettingsSectionHeader icon={MonitorSmartphone} title="Настройки на всех устройствах" className="mb-1" />
      <p className="text-xs text-muted mb-3">
        Правила, оформление и главная — одинаковые на компьютере и телефоне.
      </p>
      ...
      <SettingRow
        title="Переносить настройки через Дзен-мани"
        status={status}
        help={
          <>
            <p>
