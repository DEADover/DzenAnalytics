...
/**
 * Строка настройки: название и короткий статус, рядом контрол, подробности — за
 * знаком вопроса.
 *
...
export function SettingRow({
  ...
  return (
    <div className={`${dense ? "py-1.5" : "py-3"} border-b border-border/60 last:border-b-0`}>
      ...
      >
        {/* Во всплывающем окне колонка в 26rem шире самого окна: подпись занимала
            всю его ширину, а контрол уезжал на строку ниже — пять настроек
            превращались в десять строк с провалами между ними. Там подпись
            занимает своё место, а контрол прижимается к правому краю: разносить
            их нечем, окно и так узкое. */}
        <div className={dense ? "min-w-0" : "min-w-0 w-full sm:w-[26rem] sm:shrink-0"}>
